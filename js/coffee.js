...
class Coffee {
    ...
    serveIt() {
        ...
        //IMG title attribute
        cup.setAttribute("title", `A ${this.size} size coffee.`); // <img src="images/coffee-cup.svg" height="cupSize" title="description">
...
var priyanshLatte = new Latte("medium", false, "2%");
